            ...
            <div class="item"
              ...
              <FormItem>
                <div class="form-group">
                  <FormItem :prop="'items.' + index + '.name'" label="参观姓名" :rules="ruleValidate.name">
                    <Input size="large" v-model.trim="item.name" placeholder="请输入参观人姓名"/>
                  </FormItem>
                  <FormItem :prop="'items.' + index + '.age'" label="参观年龄" :rules="ruleValidate.age">
