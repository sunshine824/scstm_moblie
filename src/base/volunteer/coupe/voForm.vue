    ...
    <div class="form-con clearfix" v-if="isLogin">
      ...
      <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" class="form-box">
        ...
        <FormItem label="出生年月：" prop="born">
          <DatePicker size="large" ref="born" @on-change="handleDate" format="yyyy-MM-dd" type="date"
                      placeholder="请选择日期"
        ...
        <FormItem label="服务开始时间：" prop="service_sta">
          <DatePicker size="large" type="date" format="yyyy-MM-dd" placeholder="请选择开始时间"
                      v-model="formValidate.service_sta"></DatePicker>
        </FormItem>
        <FormItem label="服务结束时间：" prop="service_end">
          <DatePicker size="large" type="date" format="yyyy-MM-dd" placeholder="请选择开始时间"
                      v-model="formValidate.service_end"></DatePicker>
        </FormItem>
      ...
      handleSubmit(name) {
        this.$refs[name].validate((valid) => {
          ...
          if (valid) {
            ...
            //处理value.getTime is not a function 报错
